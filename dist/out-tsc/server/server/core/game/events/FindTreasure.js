...
var FindTreasure = /** @class */ (function (_super) {
    ...
    FindTreasure.prototype.operateOn = function (player, opts) {
        ...
        if (Date.now() < curTimer) {
            ...
            this.emitMessage([player], "You could not loot " + opts.treasureName + " because it was empty! Check back at " + new Date(curTimer) + ".", interfaces_1.AdventureLogEventType.Explore);
            return;
        }
        // 30 minute cooldown
