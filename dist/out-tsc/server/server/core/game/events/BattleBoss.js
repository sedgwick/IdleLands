...
var BattleBoss = /** @class */ (function (_super) {
    ...
    BattleBoss.prototype.operateOn = function (player, opts) {
        ...
        if (Date.now() < curTimer) {
            this.emitMessageToNames(allPlayers, "You could not encounter " + (opts.bossParty || opts.bossName) + " because they were not available! Check back at " + new Date(curTimer) + ".", interfaces_1.AdventureLogEventType.Combat);
            return;
        }
